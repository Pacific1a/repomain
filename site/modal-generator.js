            ...
            <div class="sub_partner">
                <div class="sub_title">
                    ...
                    <div class="field_button">
                        ...
                        <div class="btn_parnters btn_parnters_sub">
                            <input type="text" placeholder="https://duopartners.xyz/?partner=CODE">
        ...
        ref_program: () => `
            <div class="ref_program">
                <div class="ref_program_subtitle">
                    ...
                    <div class="sub_ref_info">
                        <span>В основе нашей реферальной программы лежит простая модель разделения прибыли (RevShare), которая позволяет Вам получать 10% от каждого депозита привлеченного вами клиента в бота.</span>
                    </div>
                    <div class="field_button">
                        <div class="link-refferal">
        ...
        auth_2f: () => `
            <div class="auth_2f">
                <div class="auth_title">
                    ...
                    <div class="auth_qr">
                        <img src="" alt="QR Code" style="width: 100%; max-width: 350px; height: auto; display: block; margin: 0 auto;" />
                    </div>
