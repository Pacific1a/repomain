...
def payment_method_finl() -> InlineKeyboardMarkup:
    ...
    status_cactuspay_kb     = ikb("✅", data="payment_method:CactusPay:False")
    ...
    if get_payments.way_cactuspay == "False":
        status_cactuspay_kb = ikb("❌", data="payment_method:CactusPay:True")
    ...
    keyboard.row(
        ...
        ikb("🌵 CactusPay", url="http://cactuspay.pro"), status_cactuspay_kb,
    )
...
# Управление CactusPay
def payment_cactuspay_finl() -> InlineKeyboardMarkup:
    keyboard = InlineKeyboardBuilder()

    keyboard.row(
        ikb("🌵 Изменить 🖍", data="payment_cactuspay_edit"),
    )
