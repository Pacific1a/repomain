...
PARTNER_API_SECRET = os.getenv('PARTNER_API_SECRET', 'e1e6547a80623ab936abfe561a8a0871')  # Секретный ключ для webhook (ОБЯЗАТЕЛЬНО установите через переменную окружения!)
