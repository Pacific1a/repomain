class CrashChart {
  ...
  drawChart() {
    ...
    for (let i = 0; i < visiblePoints.length; i++) {
      ...
      const x = this.padding.left + chartWidth * ((this.maxVisibleTime - timeSincePoint) / this.maxVisibleTime);
  ...
  drawCrashAnimation() {
    ...
    const lastX = this.padding.left + chartWidth * ((this.maxVisibleTime - (elapsedTotal - lastPoint.time)) / this.maxVisibleTime);
